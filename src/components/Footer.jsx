...
import footer from '../../public/images/more/24.jpg'
    ...
    <>
      <div style={{
        ...
        <div className='max-w-7xl mx-auto '>
          ...
          {/* <div className="bg-[url('../../public/images/more/24.png')] bg-cover bg-center h-screen"></div> */}
        </div>

      </div>
      <div className="bg-cover bg-center" style={{ backgroundImage: `url(${footer})` }}>
        <p className='text-xl font-[Rancho] text-center py-2 '>Copyright Espresso Emporium ! All Rights Reserved</p>
      </div>
    </>
  );
};
